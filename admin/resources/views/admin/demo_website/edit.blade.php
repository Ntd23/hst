...
@section('content')
    <form method="POST" action="{{ route('portfolio.websites.update', $website->id) }}" accept-charset="UTF-8"
        enctype="multipart/form-data" id="botble-portfolio-forms-project-form" class="js-base-form dirty-check"
            ...
            <div class="d-flex">
                ...
                <div class="w-100">
                    Bạn đang chỉnh sửa phiên bản tiếng "<strong
                        class="current_language_text">{{ $current_lang->lang_name }}</strong>"
                </div>
            </div>
        </div>
        <div class="row">
                    ...
                    <div class="card-body">
                        <div class="form-body">
                            <div class="mb-3 position-relative">
                                <input hidden id="lang_code" type="text" name="lang_code" value="">
                            ...
                            @if (!$website->ref_lang && $lang_default->lang_name == $current_lang->lang_name)
                                <div class="mb-3 ">
                                        ...
                                        <div class="mb-3 position-relative">
                                            ...
                                            <div class="input-group input-group-flat">
                                                ...
                                                <input class="form-control ps-0" type="text" name="slug"
                                                    id="slug" required="required" aria-required="true"
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <input class="form-control" data-counter="250" name="url_client" type="text"
                                                id="url_client" value="{{ old('url_client', $website->url_client) }}">
                                        </div>
                                        <div class="col">
                                            ...
                                            <input class="form-control" data-counter="250" name="url_admin" type="text"
                                                id="url_admin" value="{{ old('url_admin', $website->url_admin) }}">
                                        </div>
                                    </div>
                                ...
                                <div class="mb-3 position-relative">
                                    ...
                                    <select name="web_id" id="web_id" class="form-control">
                                        ...
                                        @foreach ($websites as $website_item)
                                            <option {{ $website->web_id == $website_item->id ? 'selected' : '' }}
                            ...
                            <div class="mb-3 position-relative">
                                ...
                                <textarea name="description" id="editor" class="form-control editor seo-desc">{{ old('description', $website->description) }}</textarea>
                            </div>
                            ...
                            <div class="seo-preview" v-pre>
                                ...
                                <div class="existed-seo-meta">
                                    ...
                                    <div class="page-url-seo">
                                        <p id="link-seo">{{ url('/') }}/website-demos/{{ $website->slug }}</p>
                                    </div>
                            ...
                            <div class="seo-edit-section" v-pre="">
                                ...
                                <div class="mb-3 position-relative">
                                    ...
                                    <input class="form-control" data-counter="250" name="seo_title" type="text"
                                        id="seo_title" value="{{ old('seo_title', $website->seo_title) }}">
                                </div>
                                <script>
                                ...
                                <div class="mb-3 position-relative">
                                    ...
                                    <textarea class="form-control" data-counter="160" rows="3" placeholder="Mô tả trang" data-allow-over-limit=""
                                        name="seo_description" cols="50" id="seo_description">{{ old('seo_description', $website->seo_description) }}</textarea>
                                </div>
            ...
            <div class="col-md-3 gap-3 d-flex flex-column-reverse flex-md-column mb-md-0 mb-5">
                ...
                <div class="card meta-boxes mb-3" id="language_advanced_wrap">
                    ...
                    <div class="card-body">
                        <input name="language" hidden value="{{ $current_lang->lang_code }}">
                        @foreach ($lang_list as $lang_item)
                            <div id="list-others-language mt-3">
                                <a class="gap-2 d-flex align-items-center text-decoration-none"
                                    href="{{ route('portfolio.websites.edit', $website->id) }}@if ($lang_item->lang_is_default == 0)?ref_lang={{ $lang_item->lang_code }} @endif "target="_blank">
                                    <img src="{{ url('/') }}/vendor/core/core/base/img/flags/{{ $lang_item->lang_flag }}.svg"
                                        title="{{ $lang_item->lang_name }}" class="flag" style="height: 16px"
                                        loading="lazy" alt="{{ $lang_item->lang_name }} flag">
                                    <span>{{ $lang_item->lang_name }} <svg class="icon  svg-icon-ti-ti-external-link"
                                            xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    ...
                                    <div class="preview-image-inner">
                                        <a id="chooseImageBtn" class="image-box-actions" data-result="image"
                                            ...
                                            <img id="previewImg" class="preview-image default-image"
                                                data-default="{{ url('/') }}/storage/{{ $website->img_feautrer }}"
                                                src="{{ url('/') }}/storage/{{ $website->img_feautrer }}"
                                                alt="Ảnh xem trước">
                                    ...
                                    <div class="preview-image-inner">
                                        <a id="chooseFullImageBtn" class="image-box-actions" data-result="image"
                                            ...
                                            <img id="previewImgFull" class="preview-image default-image"
                                                data-default="{{ url('/') }}/storage/{{ $website->img_full }}"
                                                src="{{ url('/') }}/storage/{{ $website->img_full }}"
                                                alt="Ảnh xem trước">
                                            <span class="image-picker-backdrop"></span>
                                        </a>
